...
},
{
  ...
  en: {
    badge: 'Collaboration',
    title: 'FOUND integrates Global Index Mapper platform with Colombia\'s Search Unit (UBPD)',
  ...
  es: {
    badge: 'Colaboración',
    title: 'FOUND integra la plataforma Global Index Mapper con la Unidad de Búsqueda (UBPD) de Colombia',
    body: '<p>Viajamos a Colombia para trabajar junto al equipo de la <strong>Unidad de Búsqueda (UBPD)</strong>. La agencia ahora tendrá control total de las herramientas de FOUND y la capacidad de incorporar nuevas capas y configuraciones.</p><p>Las plataformas, construidas por nuestro miembro principal <strong>CentroGeo</strong>, habilitan dos capacidades críticas:</p><p><strong>[1] Localizar sitios clandestinos</strong> mediante la referencia cruzada de IA, datos institucionales y evidencia de campo de nuestros sitios experimentales en México, reduciendo dónde las autoridades necesitan buscar.</p><p><strong>[2] Detectar fosas clandestinas</strong> a través de índices espectrales e imágenes satelitales y de drones, leyendo los rastros ambientales dejados atrás.</p><p>Ahora hemos integrado imágenes satelitales desde principios de los años 1980. Lo que los drones no pueden ver hoy, los satélites podrían haber grabado. Este enfoque ya ha demostrado ser efectivo en dos casos, demostrando el poder de los datos históricos en la localización de personas desaparecidas.</p><figure style="margin: 1.5em 0; text-align: center;"><img src="https://github.com/FOUND-project/found-project.github.io/raw/9d3b508af5c500046a0806cc047ff9a1b06dd5ab/images/IMG_20260217_165004.jpg?w=800" alt="Colaboración del equipo FOUND con UBPD de Colombia" style="max-width: 100%; height: auto; border-radius: 8px; margin: 0.5em 0;"/></figure><figure style="margin: 1.5em 0; text-align: center;"><img src="https://github.com/FOUND-project/found-project.github.io/raw/9d3b508af5c500046a0806cc047ff9a1b06dd5ab/images/IMG_20260217_172823.jpg?w=800" alt="Demostración de integración de plataforma UBPD" style="max-width: 100%; height: auto; border-radius: 8px; margin: 0.5em 0;"/></figure><p><a href="https://www.linkedin.com/posts/miguelmoctezuma_updates-ugcPost-7439250842781831168-a57F?utm_source=share&utm_medium=member_desktop&rcm=ACoAAB_zGzMBBxcSdtDzNCGsySXIVWQmE2nBr-E" target="_blank" rel="noopener noreferrer">Leer la publicación completa en LinkedIn →</a></p>'
        ...
        },
        {
          ...
          featured: true,
          category: 'partnership',
          en: { badge: 'Event', title: 'FOUND and Indira Navarro at Oxford\'s "Disappearance of Worlds" exhibition', body: '<p>In <strong>June 2025</strong>, FOUND and <strong>Indira Navarro</strong> took part in <strong>"Disappearance of Worlds"</strong>, an exhibition by artist Chantal Meza at the <strong>University of Oxford</strong>, presented as part of the Oxford Festival of the Arts.</p><p>The exhibition paired Meza\'s work with dialogues on disappearance, bringing together art, research, and the testimony of searching families to confront the scale of Mexico\'s missing persons crisis.</p><p><strong>Presented with:</strong></p><ul><li>University of Oxford</li><li>ICRC</li><li>Pembroke College JCR Art Collection</li><li>Oxford Festival of the Arts</li><li>Centre for the Study of Violence, University of Bath</li><li>FrontierTech</li><li>Violence &amp; Transitional Justice Lab, University of Notre Dame</li><li>Human Rights Program, Universidad Iberoamericana</li></ul><p><a href="https://artsfestivaloxford.org/events/chantal-meza-the-disappearance-of-worlds/" target="_blank" rel="noopener noreferrer">View the exhibition on the Oxford Festival of the Arts ↗</a></p>' },
          es: { badge: 'Evento', title: 'FOUND e Indira Navarro en la exposición "Disappearance of Worlds" en Oxford', body: '<p>En <strong>junio de 2025</strong>, FOUND e <strong>Indira Navarro</strong> participaron en <strong>"Disappearance of Worlds"</strong>, una exposición de la artista Chantal Meza en la <strong>Universidad de Oxford</strong>, presentada como parte del Oxford Festival of the Arts.</p><p>La exposición combinó la obra de Meza con diálogos sobre la desaparición, reuniendo arte, investigación y el testimonio de las familias buscadoras para confrontar la magnitud de la crisis de personas desaparecidas en México.</p><p><strong>Presentada junto con:</strong></p><ul><li>Universidad de Oxford</li><li>CICR</li><li>Pembroke College JCR Art Collection</li><li>Oxford Festival of the Arts</li><li>Centre for the Study of Violence, Universidad de Bath</li><li>FrontierTech</li><li>Violence &amp; Transitional Justice Lab, Universidad de Notre Dame</li><li>Programa de Derechos Humanos, Universidad Iberoamericana</li></ul><p><a href="https://artsfestivaloxford.org/events/chantal-meza-the-disappearance-of-worlds/" target="_blank" rel="noopener noreferrer">Ver la exposición en Oxford Festival of the Arts ↗</a></p>' }
        },
        {
          ...
          featured: true,
          category: 'partnership',
          en: { badge: 'Event', title: 'FOUND presents its first book at the Guadalajara International Book Fair', body: '<p>In <strong>December 2024</strong>, FOUND presented its book <strong>"Interpretar la naturaleza para encontrar a quienes nos faltan, Volumen 1"</strong> (Interpreting Nature to Locate Those We Are Missing Vol. 1) at the <strong>Guadalajara International Book Fair (FIL)</strong>, the largest book fair in the Spanish-speaking world.</p><p>The presentation brought together members of the FOUND team to share how the project uses satellite imagery, drone-based sensing, and forensic science — developed alongside searching families — to locate clandestine graves in Mexico.</p><p><a href="https://jalisco.quadratin.com.mx/principal/presentan-interpretar-la-naturaleza-para-encontrar-a-quienes-nos-faltan/" target="_blank" rel="noopener noreferrer">Read the coverage on Quadratín Jalisco ↗</a></p>' },
          es: { badge: 'Evento', title: 'FOUND presenta su primer libro en la Feria Internacional del Libro de Guadalajara', body: '<p>En <strong>diciembre de 2024</strong>, FOUND presentó su libro <strong>"Interpretar la naturaleza para encontrar a quienes nos faltan, Volumen 1"</strong> en la <strong>Feria Internacional del Libro de Guadalajara (FIL)</strong>, la feria del libro más grande del mundo hispanohablante.</p><p>La presentación reunió a integrantes del equipo de FOUND para compartir cómo el proyecto utiliza imágenes satelitales, sensores montados en drones y ciencia forense — desarrollados junto con las familias buscadoras — para localizar fosas clandestinas en México.</p><p><a href="https://jalisco.quadratin.com.mx/principal/presentan-interpretar-la-naturaleza-para-encontrar-a-quienes-nos-faltan/" target="_blank" rel="noopener noreferrer">Lee la cobertura en Quadratín Jalisco ↗</a></p>' }
        }
      ];
      var UI = {
