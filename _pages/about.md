...
.lang-toggle{position:absolute;top:1.4rem;right:var(--shell-pad);display:inline-flex;gap:.45rem;z-index:3}
...
@media(max-width:860px){
  ...
  .tl-item::before,.tl-year::before{display:none}
  .tl-track::before{content:'';position:absolute;left:7px;right:auto;top:0;bottom:0;width:2px;height:auto;margin:0;background:linear-gradient(180deg,rgba(122,190,158,.9),rgba(212,175,55,.95),rgba(122,190,158,.9));z-index:0;pointer-events:none}
