...
.featured-pub-card{display:inline-flex;flex-direction:column;align-items:flex-start;gap:.4rem;width:290px;max-width:100%;padding:1.05rem 1.35rem 1.15rem;border-radius:22px;background:linear-gradient(135deg,rgba(255,255,255,.96) 0%,rgba(253,248,232,.92) 100%);border:1px solid rgba(212,175,55,.4);box-shadow:var(--shadow-md);text-decoration:none;text-align:left;position:relative;isolation:isolate;overflow:hidden;transition:transform .25s var(--transition-smooth),box-shadow .25s var(--transition-smooth),border-color .25s var(--transition-smooth)}
...
.featured-pub-eyebrow{display:inline-flex;align-items:center;gap:.35rem;font-family:var(--font-mono);font-size:.66rem;font-weight:750;letter-spacing:.12em;text-transform:uppercase;color:#8a6d00}
.featured-pub-title{font-family:var(--font-body);font-size:1.02rem;font-weight:800;color:var(--dark-green);line-height:1.4;letter-spacing:-.01em}
.featured-pub-meta{font-size:.78rem;color:var(--text-light);font-weight:500}
.featured-pub-link{font-family:var(--font-mono);font-size:.68rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--primary-green);display:inline-flex;align-items:center;gap:.3rem;margin-top:.15rem;transition:gap .2s var(--transition-smooth)}
