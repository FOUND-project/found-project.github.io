      ...
      <div class="dual-column">
        <section id="technologies">
          ...
          <div class="image-gallery">
            ...
            <div class="gallery-item touch-zoomable">
              <img src="https://github.com/FOUND-project/found-project.github.io/blob/master/images/layers.jpg" alt="Technology deployment in field" loading="lazy" class="loading" onload="this.classList.remove('loading')">
            </div>
            <div class="gallery-item touch-zoomable">
