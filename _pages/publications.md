  ...
  <style>
    *{
    ...
    :root{
      ...
      --gray-700:#37423d;
      --gray-900:#121615;
      --shadow-sm:0 2px 8px rgba(15,41,31,.08);
      --shadow-md:0 6px 20px rgba(15,41,31,.12);
      --shadow-lg:0 12px 32px rgba(15,41,31,.18);
      --transition-base:.25s cubic-bezier(.4,0,.2,1);
    }

    /* make Minimal Mistakes content full width */
    .page,#main,.initial-content,.page__inner-wrap,.page__content,.archive{
      max-width:none!important;
      width:100%!important;
    }

    /* move grey "Publications" title so it clears the round logo */
    .page__title,
    .page-title{
    ...
    /* main shell – aligned with News */
    .pub-shell{
      max-width:1400px;
      margin:0 auto 4rem 6.8rem; /* same left offset as News */
    ...
    .pub-shell::before{
      ...
      inset:0;
      background:
        radial-gradient(circle at 10% 20%,rgba(var(--primary-green-rgb),.04) 0%,transparent 50%),
        radial-gradient(circle at 90% 80%,rgba(212,175,55,.03) 0%,transparent 50%);
      pointer-events:none;
      z-index:-1;
    }

    /* LANGUAGE TOGGLE (top-right, like News) */
    .lang-toggle{
      position:absolute;
      top:0.25rem;
      right:0;
    ...
    .pub-pill{
      ...
      padding:.35rem 1rem;
      border-radius:9999px;
      border:1px solid rgba(27,77,62,.3);
    ...
    .pub-card-featured{
      grid-column:1 / -1;
      background:linear-gradient(135deg,rgba(232,245,239,.5) 0%,rgba(255,255,255,.9) 100%);
    ...
    .pub-badge{
      ...
      border-radius:9999px;
      border:1px solid rgba(27,77,62,.25);
    ...
    .pub-card-media{
      ...
      overflow:hidden;
      box-shadow:var(--shadow-lg);
      border:1px solid rgba(27,77,62,.1);
      background:#fff;
      width:200px;
      height:280px;
      flex-shrink:0;
    ...
    /* responsive (kept, but layout still desktop-ish) */
      ...
      document.addEventListener('DOMContentLoaded', function(){
        ...
        document.querySelectorAll('img').forEach(img=>{
          if(!img.complete){
            ...
            if(img.parentElement){ img.parentElement.classList.add('skeleton'); }
          }
        });
      });
    })();
